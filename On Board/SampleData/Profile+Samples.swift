...
extension Profile {
    ...
    static let samples: [Profile] = [
        ...
        Profile(id: SampleProfileID.layla,  handle: "laylah",   displayName: "Layla Haddad",   bio: "mech eng. building things that occasionally don't catch fire.", avatarUrl: "https://randomuser.me/api/portraits/women/65.jpg"),
        ...
        Profile(id: SampleProfileID.kevin,  handle: "kevinz",   displayName: "Kevin Zhang",    bio: "finance major, day-trading my meal plan money. don't tell my mom.", avatarUrl: "https://randomuser.me/api/portraits/men/75.jpg"),
        Profile(id: SampleProfileID.ben,    handle: "benw",     displayName: "Ben Whitman",    bio: "transferred in this semester, still lost 70% of the time.", avatarUrl: "https://randomuser.me/api/portraits/men/12.jpg"),
        Profile(id: SampleProfileID.nora,   handle: "noraf",    displayName: "Nora Fitzgerald",bio: "here for the vibes and the video games.",               avatarUrl: "https://randomuser.me/api/portraits/women/58.jpg"),
        Profile(id: SampleProfileID.zainab, handle: "zainabr",  displayName: "Zainab Rahman",  bio: "pre-med, running on coffee and spite.",                 avatarUrl: "https://randomuser.me/api/portraits/women/50.jpg"),
        Profile(id: SampleProfileID.tyler,  handle: "tylerb",   displayName: "Tyler Brooks",   bio: "professional roommate complainer.",                     avatarUrl: "https://randomuser.me/api/portraits/men/29.jpg"),
    ]
